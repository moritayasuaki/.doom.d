;;; my-homage-white-theme.el --- minimal white theme inspired by editors from 2000s -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup my-homage-white-theme nil
  "Options for the `my-homage-white' theme."
  :group 'doom-themes)

(defcustom my-homage-white-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'my-homage-white-theme
...
(def-doom-theme my-homage-white
  "A light theme inspired by Atom One"

  ;; name        default   256       16
  ((bg         '("#fafafa" "#fafafa" nil            ))
   (bg-alt     '("#f0f0f0" "#f0f0f0" nil            ))
   ...
   (-modeline-bright t)
   (-modeline-pad
    (when my-homage-white-padded-modeline
      (if (integerp my-homage-white-padded-modeline) my-homage-white-padded-modeline 4)))
...
;;; my-homage-white-theme.el ends here
