...
(setq user-full-name "Yasuaki Morita"
      user-mail-address "zousandazou@gmail.com")
...
;; This will open documentation for it, including demos of how th-ey are used.
...
;;(after! org
;;  (custom-set-faces!
;;    '(outline-1 :inherit t :height 1.5)
;;    '(outline-2 :inherit t :height 1.4)
...
(after! emacs-everywhere
  (setq! emacs-everywhere-frame-name-format "Everywhere"))
...
(after! treeemacs
  (require 'dired)
  (setq treeemacs-file-ignore-extensions
    '("bbl" "aux" "toc" "fls" "agdai")))
(setq projectile-project-search-path '("~/projects"))
(setq projectile-ignored-projects '("~/" "~/.doom.d" "~/.emacs.d/.local/straight/"))
...
(setq bibtex-completion-bibliography "~/Zotero/cs.bib")
